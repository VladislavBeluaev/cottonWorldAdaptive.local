...
-- Дамп данных таблицы uzbolkab_cottonworld.orders: ~87 rows (приблизительно)
...
INSERT INTO `t_shirts` (`id`, `name`, `routeKeyName`, `description`, `material`, `composition`, `density`, `price`, `gender_id`, `t_shirts_types_id`, `material_quality_id`, `t_shirt_sleeve_id`, `created_at`, `updated_at`) VALUES
	...
	(10, 'Детская футболка', 'children_t-shirt', 'Горловина обработана рибаной с эластаном, закрытый «росток», усиление плеч, двойная отстрочка по проймам и срезам рукавов.', 'Кулирная гладь', '100% хб', '160 гр/м²', '2,08', 3, 1, 2, 1, '2019-05-15 00:31:58', '2019-05-15 00:31:58');
